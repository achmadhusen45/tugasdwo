    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                ...
                <div class="sidebar-brand-text mx-3">Kelompok 7</div>
            </a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Salling Fact</h1>
                    </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Jumlah Transaksi Yang Terjadi</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php  
                                                 ...
                                                 $mysqli     = mysqli_connect($host, $user, $password, $database);
                                                    ...
                                                    $sql = "SELECT COUNT(SalesOrderID) as jumlah_cust from product_selling_fact";
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Jumlah Product Yang Terjual</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php
                                            $sql = "SELECT COUNT(ProductID) as jumlah_cust from product_selling_fact";
                                                $query = mysqli_query($mysqli,$sql);
                                                    while($row2=mysqli_fetch_array($query)){
                                                        echo number_format($row2['jumlah_cust'],0,".",",");
                                                 }
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Jumlah Sales Person Yang Berhasil Melakukan Transaksi
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                                                    <?php
                                                    $sql = "SELECT COUNT(DISTINCT BusinessEntityID) as jumlah_cust from product_selling_fact";
                                                        $query = mysqli_query($mysqli,$sql);
                                                            while($row2=mysqli_fetch_array($query)){
                                                                echo number_format($row2['jumlah_cust'],0,".",",");
                                                        }
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Total Penujualan Per Bulan</h6>
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Total Penjualan Berdasarkan Sales Person </h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <div class="chart-area">
                                        ...
                                        <?php
                                            ...
                                            $lamapinjam = mysqli_query($mysqli,"SELECT DISTINCT(BusinessEntityID), COUNT(ProductID) as ProductID FROM product_selling_fact WHERE ProductID IS NOT NULL AND ProductID > 0 GROUP BY BusinessEntityID ORDER BY ProductID DESC");
                                            while($row = mysqli_fetch_array($lamapinjam)){
                                                $jenis_lamapinjam[] = $row['BusinessEntityID'];

                                                $query = mysqli_query($mysqli,"SELECT COUNT(ProductID) as ProductID FROM product_selling_fact WHERE BusinessEntityID IS NOT NULL AND BusinessEntityID > 0 AND BusinessEntityID='".$row['BusinessEntityID']."'");
                                                $row = $query->fetch_array();   
                                                $customer[] = $row['ProductID'];
                                            };
                                            ?>
