                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Jumlah Transaksi Pembelian Product</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php  
                                                 ...
                                                 $sql = "SELECT COUNT(DISTINCT PurchaseOrderID) as total_pendapatan from product_stock_fact";
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Jumlah Product Yang Di Beli</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php
                                            $sql = "SELECT COUNT(DISTINCT ProductID) as jumlah_transaksi from product_stock_fact";
                                            $query = mysqli_query($mysqli,$sql);
                                                 while($row2=mysqli_fetch_array($query)){
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Jumlah Vendor Yang Melakukan Pengiriman
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                                                    <?php
                                                    $sql = "SELECT COUNT(DISTINCT VendorID) as jumlah_transaksi from product_stock_fact";
                                                        $query = mysqli_query($mysqli,$sql);
                                                            while($row2=mysqli_fetch_array($query)){
                                                                echo number_format($row2['jumlah_transaksi'],0,".",",");
                                                        }
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Total Pembelian Per Bulan</h6>
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Total Pembelian Berdasarkan Vendor</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body-store">
                                    <div class="chart-area-store">
                                        ...
                                        <?php
                                            ...
                                            $tahun = mysqli_query($mysqli,"SELECT DISTINCT(VendorID), COUNT(PurchaseOrderID) as PurchaseOrderID FROM product_stock_fact WHERE VendorID IS NOT NULL AND VendorID > 0 GROUP BY VendorID ORDER BY PurchaseOrderID DESC");
                                            while($row = mysqli_fetch_array($tahun)){
                                                $jenis_tahun[] = $row['VendorID'];

                                                $query = mysqli_query($mysqli,"SELECT COUNT(PurchaseOrderID) as VendorID FROM product_stock_fact WHERE VendorID IS NOT NULL AND VendorID > 0 AND VendorID='".$row['VendorID']."'");
